...
namespace WebClient2 // Note: actual namespace depends on the project name.
{
    ...
    internal class Program2
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            string responseBody = await client.GetStringAsync($"https://api.jcdecaux.com/vls/v3/stations?contract={contractName}&apiKey={api_key}");
